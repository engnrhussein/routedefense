...
export default function Poster() {
  return (
    <div className="min-h-screen bg-[#E8DFD4] flex items-center justify-center print:block print:bg-[#E8DFD4]">
      ...
      >
        {/* Top Border Accent */}
        <div className="h-6 w-full bg-[#E63946]"></div>
        ...
        <div className="flex-1 flex flex-col px-20 py-24">
          <div className="mb-auto">
            ...
            <div className="flex items-center gap-6 mb-32">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 224 224" className="w-16 h-16 opacity-90">
                <path d="M 0 200 L 0 0 L 100 0 L 200 100 L 200 200 Z" fill="none" stroke="#111111" strokeWidth="24" strokeLinejoin="miter" />
                <path d="M 0 200 L 0 100 L 100 100 L 100 200 Z" fill="none" stroke="#111111" strokeWidth="24" strokeLinejoin="miter" />
              </svg>
          ...
          <div className="mt-auto border-t-[3px] border-[#CFC6B8] pt-16 flex justify-between items-end">
            ...
            {/* QR Code Placeholder Box (User can replace with real QR later) */}
            <div className="w-48 h-48 border-4 border-[#111111] p-2 flex items-center justify-center bg-white relative">
